...
public class MinFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.min_page, container, false);

        recyclerView = view.findViewById(R.id.recyclerView);
        recyclerView.setHasFixedSize(true);
        recyclerView.setLayoutManager(new LinearLayoutManager(getContext()));
        recyclerView.setAdapter(new RecyclerViewAdapter(Client.Unit.minutes));
        ...
        fragment.AddInfo(Client.Unit.minutes, Transaction.Type.Buy,
                Market.GetFromMemory(getContext()).minute_buy, 0,
        ...
        fragment1.AddInfo(Client.Unit.minutes, Transaction.Type.Sell,
                Market.GetFromMemory(getContext()).minute_sell, 0,
                Client.GetFromMemory(getContext()).balance);
